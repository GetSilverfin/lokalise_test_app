...
LokaliseRails::GlobalConfig.config do |c|
  ...
  # se => Svenska/Northern Sami
  supported_locales = "en,fr"
  source_locales = ENV.fetch("LOKALISE_SOURCE_LOCALES", supported_locales).then { |locales| locales.split(",") }
  target_locales = ENV.fetch("LOKALISE_TARGET_LOCALES", supported_locales).then { |locales| locales.split(",") }
